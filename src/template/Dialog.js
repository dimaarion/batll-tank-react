...
import {dialogOpenClose} from "../redux/features/DialogView";
...
export default function Dialog() {
    ...
    return <>
            <div
                className={`${!selectorDialogView.value?" w-0 h-[120px] left-0 ":" dialog p-10 "} fixed  z-30 bottom-0 bg-no-repeat`}>
                ...
                }} onPointerDown={()=>dispatch(cameraDialog())} onPointerUp={()=>dispatch(cameraStop())} className="absolute right-[-28px] top-0 bottom-0 my-auto h-[120px]">
