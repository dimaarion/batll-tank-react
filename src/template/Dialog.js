...
export default function Dialog() {
    ...
    if (s) {
        return <>
            <div
                className={`${!hidden?"w-0 h-[120px] left-0":"lg:w-[800px] lg:h-[150px] w-[300px] h-[300px] bg-[url(https://game.fk-i-s.ru/asset/img/gui/dialog-mob.png)] lg:bg-[url(https://game.fk-i-s.ru/asset/img/gui/dialog.png)] p-10"}  z-30 bottom-0  absolute bg-no-repeat`}>
                {hidden ? <>
