                    ...
                    <g>
                        <g transform="translate(25 51)">
                            <g transform="translate(52 0)">
                                <path d="M8.5 0C13.1951 0 17 3.80494 17 8.5L17 36.5C17 41.1951 13.1951 45 8.5 45L8.5 45C3.80494 45 0 41.1951 0 36.5L0 8.5C0 3.80494 3.80494 0 8.5 0Z" fill="#3949AB" />
                                <path d="M8.5 0C13.1951 0 17 3.80494 17 8.5L17 36.5C17 41.1951 13.1951 45 8.5 45L8.5 45C3.80494 45 0 41.1951 0 36.5L0 8.5C0 3.80494 3.80494 0 8.5 0Z" fill="#AB3939" transform="translate(17 0)" />
                            </g>
                            <g transform="translate(83 0)">
                                <g fill="#000000" fillRule="evenodd">
                                    <rect width="53" height="45" />
                                    <path d="M53 0L0 0L0 45L53 45L53 0ZM2 43L2 2L51 2L51 43L2 43Z" fill="#BDBDBD" fillRule="evenodd" />
                                </g>
                                <text id="tank-count-bot" x="20" y="30" fontSize="20pt" fill="#FFECB3">{countBot.value}</text>
                            </g>
                            <g>
                                <g fill="#000000" fillRule="evenodd">
                                    <rect width="53" height="45" />
                                ...
                                <text id="tank-count-player" x="20" y="30" fontSize="20pt" fill="#FFECB3">{countPlayer.value}</text>
                            </g>
                        </g>
                        <g>
                            <g>
                                <g fill="#000000" fillRule="evenodd">
                                    ...
                                    <path d="M181 0L0 0L0 50L181 50L181 0ZM2 48L2 2L179 2L179 48L2 48Z" fill="#BDBDBD" fillRule="evenodd" />
                                </g>
                                <g x="10">
                                    <text id="tank-clock-min" x="80" y="30" fontSize="20pt" fill="#FFECB3">{minutes.value < 10?"0" + minutes.value:minutes.value}</text>
                                    <text x="110" y="30" fontSize="20pt" fill="#FFECB3">:</text>
                                    <text id="tank-clock-sec" x="120" y="30" fontSize="20pt" fill="#FFECB3">{seconds.value < 10?"0" + seconds.value:seconds.value}</text>
                                </g>
