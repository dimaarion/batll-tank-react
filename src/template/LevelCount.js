            ...
            <svg width="53" height="49.99" viewBox="0 0 53 49.99" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <g transform="translate(1.5 0)">
                    <g fill="#1F2324" fillRule="evenodd">
                        ...
                        <path d="M49.99 0L0 0L0 49.99L49.99 49.99L49.99 0ZM4 45.99L4 4L45.99 4L45.99 45.99L4 45.99Z"  className={` ${active}`} fillRule="evenodd" />
                    </g>
                    ...
                    <text x="45%" y="50%" className="text-xl"  dominantBaseline="middle" textAnchor="middle" fill="#c6bcbc" fillRule="evenodd" >{props.num}</text>
                </g>
            </svg>
